# Strawberry Fruit Disease Detection Dataset】5 categories including rubber disease gray mold disease powdery mildew disease black spot disease

# Body

Strawberry Fruit Disease Detection Dataset】This dataset consists of five categories, including rubber disease, gray mold disease, powdery mildew, black spot disease, and normal fruits. The total number of images is: training set 2717, validation set 690. Below are the results after training with YOLOv8. Data augmentation has been applied! The annotation file format is YOLO's txt format. , and interested parties can contact us for more information.
